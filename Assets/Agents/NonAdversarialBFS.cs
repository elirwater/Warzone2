...
public class NonAdversarialBFS : Agents
{
    ...
    // A list of territories that BFS expanded upon in a Breadth style way
    // (Territory = starting territory, List<Territories = all neighbors BFS expanded to that round)
